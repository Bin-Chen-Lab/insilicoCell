...
if device == 'cpu':
    model3 = torch.jit.load("./model_checkpoint/gene_effect_score_CPU.pt", map_location=device)
else:
    model3 = torch.jit.load("./model_checkpoint/gene_effect_score_GPU.pt", map_location=device)
...
#-----------------------------------------------------------------------------------------
#python demo_gene_effect_score.py --File1 /egr/research-aidd/chenruo4/self-built_transformer/upload_no_source_version/demo_data/input_sample_info_gene_effect_score.csv --File2 /egr/research-aidd/chenruo4/self-built_transformer/upload_no_source_version/demo_data/task_gene_effect_score_cell_transcriptomes_log2TPM.csv --out pred_demo_gene_effect_score --BatchSize 16 --device GPU
