...
If your cell line is in the [pretraining dataset](https://chenlab-data-public.s3.amazonaws.com/InsilicoCell/cell_line_expression_matrix.csv), you can extract its expression profile directly from there.
