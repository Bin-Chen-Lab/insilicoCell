...
| `gene_name` | Gene name from the [supported gene list](https://github.com/Bin-Chen-Lab/insilicoCell/blob/main/InsilicoCell/model_checkpoint/gene_list.csv) (~20k genes) | Drug expression, TF-gene, gene effect, mutation, CNV |
