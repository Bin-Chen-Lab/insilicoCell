...
#task 1: 'drug-induced_gene_exp':
model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_drug-induced_gene_exp_use_GNN_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 2: 'drug-protein_binding':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_drug-protein_binding_use_GNN_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 3: 'TF-gene_regulation':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_TF_gene_regulation_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 4: 'drug_sensitivity':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_drug_sensitivity_use_GNN_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 5: 'gene_effect_score':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_gene_effect_score_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 6: 'gene_mutation':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_gene_mutation_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))

#task 7: 'gene_CNV':
#model.load_state_dict(torch.load(out_dir + 'finetune_self-built_transformer_no_modality_tokens_single-task_gene_CNV_lr0.00001_all_7_tasks_subset_1.0_portion_' + str(final_epoch) + '_20241229'))
...
df.to_csv(out_dir + 'finetuned_self-built_transformer_drug-induced_gene_exp_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
#df.to_csv(out_dir + 'finetuned_self-built_transformer_drug-induced_gene_exp_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
...
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug-induced_gene_exp_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug-induced_gene_exp_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_drug-protein_binding_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_drug-protein_binding_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
rmse = np.sqrt(mean_squared_error(df['y_truth'], df['y_pred']))
cor = df.corr().iloc[0,1]
all_val_set_performance = pd.DataFrame({'pearson_cor': cor, 'RMSE': rmse}, index = range(0, 1))
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug-protein_binding_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug-protein_binding_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_TF-gene_regulation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_TF-gene_regulation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
...
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_TF-gene_regulation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_TF-gene_regulation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_drug_sensitivity_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_drug_sensitivity_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
rmse = np.sqrt(mean_squared_error(df['y_truth'], df['y_pred']))
cor = df.corr().iloc[0,1]
all_val_set_performance = pd.DataFrame({'pearson_cor': cor, 'RMSE': rmse}, index = range(0, 1))
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug_sensitivity_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_drug_sensitivity_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_effect_score_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_effect_score_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
rmse = np.sqrt(mean_squared_error(df['y_truth'], df['y_pred']))
cor = df.corr().iloc[0,1]
all_val_set_performance = pd.DataFrame({'pearson_cor': cor, 'RMSE': rmse}, index = range(0, 1))
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_effect_score_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_effect_score_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_mutation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_mutation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
AUROC = roc_auc_score(df['y_truth'], df['y_pred']) #AUROC
AUPRC = average_precision_score(df['y_truth'], df['y_pred']) #AUPRC
df['y_pred_class'] = 0
df.loc[df['y_pred'] > 0.5, 'y_pred_class'] = 1
...
acc = accuracy_score(df['y_truth'], df['y_pred_class'])
all_val_set_performance = pd.DataFrame({'AUROC': AUROC, 'AUPRC': AUPRC, 'f1': f1, 'accuracy': acc}, index = range(0, 1))
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_mutation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_mutation_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
...
#df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_CNV_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_pred_vs_truth_20250102.csv')
df.to_csv(out_dir + 'finetuned_self-built_transformer_gene_CNV_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_pred_vs_truth_20250102.csv')
rmse = np.sqrt(mean_squared_error(df['y_truth'], df['y_pred']))
cor = df.corr().iloc[0,1]
all_val_set_performance = pd.DataFrame({'pearson_cor': cor, 'RMSE': rmse}, index = range(0, 1))
#all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_CNV_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_internal_seen_unseen_mixture_val_set_performance_20250102.csv')
all_val_set_performance.to_csv(out_dir + 'finetuned_self-built_transformer_gene_CNV_multitask_no_modality_tokens_use_GNN_drugs_lr0.00001_all_7_tasks_1.0_portion_' + str(final_epoch) + '_epoch_unseen_test_set_performance_20250102.csv')
